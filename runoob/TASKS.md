...
当前阶段: 从第 6 个任务开始
规则: 每个任务对应一个独立可运行文件，文件名使用序号前缀

| 序号 | 菜单名 | 文件名 | 状态 |
|---|---|---|---|
| 06 | Python3 基础语法 | 06_basic_syntax.py | DONE |
| 07 | Python3 基本数据类型 | 07_basic_data_types.py | DONE |
| 08 | Python3 数据类型转换 | 08_type_conversion.py | DONE |
| 09 | Python3 解释器 | 09_interpreter.py | DONE |
| 10 | Python3 注释 | 10_comments.py | DONE |
| 11 | Python3 运算符 | 11_operators.py | DONE |
| 12 | Python3 数字(Number) | 12_numbers.py | DONE |
| 13 | Python3 字符串 | 13_strings.py | DONE |
| 14 | Python3 列表 | 14_lists.py | DONE |
| 15 | Python3 元组 | 15_tuples.py | DONE |
| 16 | Python3 字典 | 16_dictionaries.py | DONE |
| 17 | Python3 集合 | 17_sets.py | TODO |
| 18 | Python3 条件控制 | 18_conditional_control.py | TODO |
| 19 | Python3 循环语句 | 19_loops.py | TODO |
| 20 | Python3 编程第一步 | 20_first_steps.py | TODO |
| 21 | Python3 推导式 | 21_comprehensions.py | TODO |
| 22 | Python3 迭代器与生成器 | 22_iterators_generators.py | TODO |
| 23 | Python3 with | 23_with_statement.py | TODO |
| 24 | Python3 函数 | 24_functions.py | TODO |
| 25 | Python3 lambda | 25_lambda_expressions.py | TODO |
| 26 | Python3 装饰器 | 26_decorators.py | TODO |
| 27 | Python3 数据结构 | 27_data_structures.py | TODO |
| 28 | Python3 模块 | 28_modules.py | TODO |
| 29 | Python __name__ | 29_name_main.py | TODO |
| 30 | Python3 输入和输出 | 30_input_output.py | TODO |
| 31 | Python3 File | 31_files.py | TODO |
| 32 | Python3 OS | 32_os_module.py | TODO |
| 33 | Python3 错误和异常 | 33_errors_and_exceptions.py | TODO |
| 34 | Python3 面向对象 | 34_object_oriented_programming.py | TODO |
| 35 | Python3 命名空间/作用域 | 35_namespaces_scope.py | TODO |
| 36 | Python 虚拟环境的创建 | 36_virtual_environment.py | TODO |
| 37 | Python 类型注解 | 37_type_annotations.py | TODO |
| 38 | Python3 标准库概览 | 38_stdlib_overview.py | TODO |
